                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_Nombre_categoria" ID="edit_Nombre_categoria" class="form-control" placeholder="" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="edit_Descripcion_categoria" class="form-label">Descripcion de la categoria</label>
                                <input type="text" name="edit_Descripcion_categoria" ID="edit_Descripcion_categoria" class="form-control" placeholder="" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_Fecha_creacion" class="form-label">fecha de creacion</label>
                                <input type="date" name="edit_Fecha_creacion" ID="edit_Fecha_creacion" class="form-control" placeholder="" required>
                            </div>


                            <div class="col-12 mb-3">
                                <label for="edit_Nombre_Producto" class="form-label">Nombre del producto</label>
                                <input type="text" name="edit_Nombre_Producto" ID="edit_Nombre_Producto" class="form-control" placeholder="" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_Costos_promedios" class="form-control" ID="edit_Costos_promedios" placeholder="" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_Img_produc" class="form-label">Img</label>
                                <input type="text" name="edit_Img_produc" ID="edit_Img_produc" class=" form-control" placeholder="" required>
                            </div>
